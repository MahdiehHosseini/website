...
function App() {
  ...
  return (
    <div className={`font-${lang === 'EN' ? 'convergence' : 'vazir text-right'} ${viablity && 'overflow-hidden'} h-screen relative flex flex-col bg-${them.mainBgColor} text-${them.mainTxtColor}`}>
      ...
      {/*classes*/}
      <span className='hidden font-convergence font-vazir bg-black text-neutral-400 text-neutral-600 bg-white bg-light-black bg-light-black/70 bg-white/70 text-white text-black border-black border-neutral-400 placeholder:text-neutral-400 border-neutral-600 placeholder:text-neutral-600 bg-neutral-800 bg-neutral-200 border-white'></span>
    </div>
  )
}
